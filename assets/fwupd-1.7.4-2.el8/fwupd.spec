...
Source300:   eurolinuxCA.cer
Source301:   eurolinux.cer
Source500:   eurolinuxCA.cer
Source503:   eurolinux.cer
...
%ifarch x86_64
    -Dfwupd-efi:efi_sbat_distro_id="eurolinux" \
    -Dfwupd-efi:efi_sbat_distro_summary="EuroLinux" \
    -Dfwupd-efi:efi_sbat_distro_pkgname="%{name}" \
    -Dfwupd-efi:efi_sbat_distro_version="%{version}" \
    -Dfwupd-efi:efi_sbat_distro_url="mail:security@euro-linux.com" \
...
%pesign -s -i %{fwup_efi_fn} -o %{fwup_efi_fn}.tmp -a %{SOURCE300} -c %{SOURCE301} -n eurolinux
%pesign -s -i %{fwup_efi_fn}.tmp -o %{fwup_efi_fn}.signed -a %{SOURCE500} -c %{SOURCE503} -n eurolinux
...
%changelog
* Tue Jun 21 2022 Kamil Aronowski <ka@euro-linux.com> - 1.7.4-2
- Rebuild for EuroLinux
